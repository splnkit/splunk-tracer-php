...
use SplunkTracing\Collector\Reference\Relationship;
use SplunkTracingBase\Client\Util;

class ProtoTypesTest extends BaseSplunkTracingTest {

    public function testAuthToProto() {
        $auth = new \SplunkTracingBase\Client\Auth(ACCESS_TOKEN);
    ...
    public function testClientSpanToProto() {
        $tracer = new \SplunkTracingBase\Client\ClientTracer();
        $span = new \SplunkTracingBase\Client\ClientSpan($tracer, 5);
...
//        $this->assertEquals(\SplunkTracingBase\Client\Util::hexdec($span->traceGUID()), $protoSpanContext->getTraceId());
//        $this->assertEquals(\SplunkTracingBase\Client\Util::hexdec($span->guid()), $protoSpanContext->getSpanId());
        ...
        $this->assertEquals(\SplunkTracingBase\Client\Util::hexdec($span->getParentGUID()), $parentContext->getSpanId());
    ...
    public function testKeyValueToProto() {
        $keyValue = new \SplunkTracingBase\Client\KeyValue("aKey", "aValue");
    ...
    public function testLogRecordToProtoNoTimestamp() {
        ...
        $logRecord = new \SplunkTracingBase\Client\LogRecord($fields);
    ...
    public function testReporterToProto() {
        ...
        $group = "my_component";
        $attr = new \SplunkTracingBase\Client\KeyValue("my_key", "my_value");
        $runtime = new \SplunkTracingBase\Client\Runtime($guid, $start, $group, [$attr]);
    ...
    public function testReportRequestToProto() {
        ...
        $start = 1538476581123456;
        $now = Util::nowMicros();
        $reportRequest = new \SplunkTracingBase\Client\ReportRequest($runtime, $start, $now, [$span], $counters);
