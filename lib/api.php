...
namespace SplunkTracingBase;

// TODO: these constants should be replaced with OpenTracing constants as soon
// as a OpenTracing PHP library exists.
define("SPLUNK_FORMAT_TEXT_MAP", "SPLUNK_FORMAT_TEXT_MAP");
define("SPLUNK_FORMAT_BINARY", "SPLUNK_FORMAT_BINARY");
 ...
 */
define("SPLUNK_JOIN_KEY_END_USER_ID", "end_user_id");

/**
 * Interface for the instrumentation library.
 *
 * This interface is most commonly accessed via SplunkTracing::getInstance()
 * singleton.
 */
interface Tracer {
